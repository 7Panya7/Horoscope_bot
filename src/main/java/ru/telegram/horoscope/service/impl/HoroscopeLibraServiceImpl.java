...
import ru.telegram.horoscope.service.HoroscopeLibraService;

@Service
@RequiredArgsConstructor
public class HoroscopeLibraServiceImpl implements HoroscopeLibraService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("libra");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
