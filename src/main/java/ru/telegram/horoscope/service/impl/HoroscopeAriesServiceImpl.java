...
import ru.telegram.horoscope.service.HoroscopeAriesService;

@Service
@RequiredArgsConstructor
public class HoroscopeAriesServiceImpl implements HoroscopeAriesService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("aries");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
