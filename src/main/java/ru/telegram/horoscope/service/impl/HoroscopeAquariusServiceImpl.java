...
import ru.telegram.horoscope.service.HoroscopeAquariusService;

@Service
@RequiredArgsConstructor
public class HoroscopeAquariusServiceImpl implements HoroscopeAquariusService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("aquarius");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
