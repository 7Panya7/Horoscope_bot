...
import ru.telegram.horoscope.service.HoroscopeTaurusService;

@Service
@RequiredArgsConstructor
public class HoroscopeTaurusServiceImpl implements HoroscopeTaurusService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("taurus");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
