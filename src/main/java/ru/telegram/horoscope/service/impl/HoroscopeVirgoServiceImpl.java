...
import ru.telegram.horoscope.service.HoroscopeVirgoService;

@Service
@RequiredArgsConstructor
public class HoroscopeVirgoServiceImpl implements HoroscopeVirgoService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("virgo");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
