...
import ru.telegram.horoscope.service.HoroscopePiscesService;

@Service
@RequiredArgsConstructor
public class HoroscopePiscesServiceImpl implements HoroscopePiscesService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("pisces");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
