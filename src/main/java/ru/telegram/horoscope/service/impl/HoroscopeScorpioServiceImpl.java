...
import ru.telegram.horoscope.service.HoroscopeScorpioService;

@Service
@RequiredArgsConstructor
public class HoroscopeScorpioServiceImpl implements HoroscopeScorpioService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("scorpio");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
