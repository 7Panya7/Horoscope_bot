...
import ru.telegram.horoscope.service.HoroscopeGeminiService;

@Service
@RequiredArgsConstructor
public class HoroscopeGeminiServiceImpl implements HoroscopeGeminiService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("gemini");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
