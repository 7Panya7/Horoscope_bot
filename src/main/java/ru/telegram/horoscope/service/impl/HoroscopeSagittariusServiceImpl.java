...
import ru.telegram.horoscope.service.HoroscopeSagittariusService;

@Service
@RequiredArgsConstructor
public class HoroscopeSagittariusServiceImpl implements HoroscopeSagittariusService {
    ...
    public SendMessage handle(long chatId, Message message) {
        var text = parserHoroscopePage.getPage("sagittarius");
        SendMessage sendMessage = new SendMessage(String.valueOf(message.getChatId()),text);
        sendMessage.setReplyMarkup(inlineKeyboardMarkup);
        return sendMessage;
    }
